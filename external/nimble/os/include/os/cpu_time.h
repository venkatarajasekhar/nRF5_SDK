...
#define CPUTIMER_SET_CHANNEL        NRF_TIMER_CC_CHANNEL2
#define CPUTIMER_SET_EVENT          NRF_TIMER_EVENT_COMPARE2

#define CPUTIMER_GET_CHANNEL        NRF_TIMER_CC_CHANNEL3
#define CPUTIMER_GET_EVENT          NRF_TIMER_EVENT_COMPARE3
