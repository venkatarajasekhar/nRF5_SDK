...
static bsp_btn_error_handler_t m_error_handler = NULL; /**< Error handler registered by the user. */
...
uint32_t bsp_btn_sleep_mode_prepare(void)
{
...
void bsp_btn_on_ble_evt(void)
{
    connection_buttons_configure();
}


uint32_t bsp_btn_init(bsp_btn_error_handler_t error_handler, bsp_event_t * p_startup_bsp_evt)
{
